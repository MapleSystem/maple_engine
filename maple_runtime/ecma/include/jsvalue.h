...
#define IS_INFINITY(V)   ((V & 0x7FFF000000000000) == 0x7FF0000000000000)  //JSTYPE_INFINITY = 0
#define IS_NULL(V)       ((V & 0x7FFF000000000000) == 0x7FF1000000000000)  //JSTYPE_NULL = 1
...
#define IS_STRING(V)     ((V & 0x7FFF000000000000) == 0x7FF4000000000000)  //JSTYPE_STRING = 4
#define IS_OBJECT(V)     ((V & 0x7FFF000000000000) == 0x7FF5000000000000)  //JSTYPE_OBJECT = 5
#define IS_NUMBER_OR_BOOL(V) ((V & 0x7FFE000000000000) == 0x7FF2000000000000)  //JSTYPE_BOOLEAN = 2, JSTYPE_NUMBER = 3
...
#define NAN_NULL        0x7FF1000000000000
#define NAN_BOOLEAN     0x7FF2000000000000
#define NAN_NUMBER      0x7FF3000000000000
#define NAN_STRING      0x7FF4000000000000
#define NAN_OBJECT      0x7FF5000000000000
#define NAN_ENV         0x7FF6000000000000
#define NAN_UNKNOWN     0x7FF8000000000000
#define NAN_UNDEFINED   0x7FF9000000000000
#define NAN_NONE        0x7FFA000000000000
#define NAN_NAN         0x7FFB000000000000
#define NAN_SPBASE      0x7FFC000000000000
#define NAN_FPBASE      0x7FFD000000000000
#define NAN_GPBASE      0x7FFE000000000000
#define NAN_FUNCTION    0x7FFF000000000000
